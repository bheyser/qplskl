...
/*		if ($rbacsystem->checkAccess("visible,read",$this->object->getRefId()))
	...
	*/
	...
	//
 	...
 	function createElbaTablesObject()
	{
		include_once("./Services/Elba/classes/class.ilElbaDBCreator.php");
		$db_creator = new ilElbaDBCreator();
		$db_creator->createTables();
	...
	*/
	function showServerInfoObject()
	{
		...
		$ilToolbar->addButton("Update Elba Tables",
			$ilCtrl->getLinkTarget($this, "createElbaTables"));
	...
	*/
	public function initBasicSettingsForm()
	{
		...
		$pl = new ilCheckboxInputGUI($this->lng->txt('adm_captcha_wiki_forum'),'activate_captcha_anonym');
		$pl->setValue(1);
		$pl->setChecked($ilSetting->get('activate_captcha_anonym'));
		$this->form->addItem($pl);
